...
typedef enum {
    ...
    FSM_STATE_MANUAL_HEATING,        // Manual heating mode (Green)
...
typedef enum {
    ...
    FSM_EVENT_MANUAL_HEATING_START,  // Start manual heating
    FSM_EVENT_MANUAL_HEATING_STOP,   // Stop manual heating
